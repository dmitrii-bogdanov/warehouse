...
public enum ExceptionType {
    ...
    ALREADY_REGISTERED_PERSON("Person with id : #ID has already been registered as user", HttpStatus.CONFLICT),
    ALREADY_RECORDED_NAME_OR_CODE("#FIELD_NAME : #FIELD_VALUE belongs to nomenclature with id : #ID", HttpStatus.CONFLICT),
    NAME_OR_CODE_IS_ALREADY_REGISTERED("#FIELD_NAME : #FIELD_VALUE is already registered", HttpStatus.CONFLICT),
    ...
    NOT_ENOUGH_AMOUNT("Nomenclature with id : #ID has not enough amount to write-off #FIELD_VALUE", HttpStatus.CONFLICT),
    ...
    POSITION_IS_IN_USE("Position with name : #FIELD_VALUE is in use", HttpStatus.CONFLICT),
    ALREADY_REGISTERED_POSITION_NAME("Position name : #FIELD_VALUE is already registered", HttpStatus.CONFLICT),
    ...
    ALREADY_REGISTERED_USERNAME("User with username : #FIELD_VALUE already registered", HttpStatus.CONFLICT),
    ...
    USER_HAS_RECORDS("User with id : #ID has records", HttpStatus.CONFLICT),
    NOMENCLATURE_HAS_RECORDS("Nomenclature with id : #ID has records", HttpStatus.CONFLICT),
    NOMENCLATURE_AMOUNT_IS_POSITIVE("Nomenclature with id : #ID amount is positive", HttpStatus.CONFLICT),
    ...
    LONG_VALUE_OVERFLOW("Operation leads to long value overflow", HttpStatus.CONFLICT),
    ...
    ALREADY_REVERTED_RECORD("Record with id : #ID was already reverted", HttpStatus.CONFLICT);
